...
#define R_IS 17 // define pin 5 for R_IS pin (output)
...
void messageCb_servo (const std_msgs::String& Vmsg){
       String servo_pin_value= String(Vmsg.data);      
...
ros::Subscriber<std_msgs::String> servo_pin("disinfection_control", messageCb_servo);
