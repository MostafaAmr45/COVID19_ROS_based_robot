...
######################################################
    ...
    #####################################################
        ...
        rospy.Subscriber("lwheel_ticks", Int16, self.wheelCallback) 
        rospy.Subscriber("lwheel_vtarget", Float32, self.targetCallback) 
        self.pub_motor = rospy.Publisher('lmotor',Float32, queue_size=10) 
        self.pub_vel = rospy.Publisher('lwheel_vactual', Float32, queue_size=10)
